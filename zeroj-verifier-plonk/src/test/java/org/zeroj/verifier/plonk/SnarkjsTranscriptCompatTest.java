package org.zeroj.verifier.plonk;

import org.zeroj.codec.SnarkjsPlonkCodec;
import org.zeroj.crypto.transcript.FiatShamirTranscript;
import org.zeroj.crypto.transcript.Keccak256;
import org.zeroj.verifier.groth16.bn254.Fp;
import org.zeroj.verifier.groth16.bn254.G1Point;
...
class SnarkjsTranscriptCompatTest {
    ...
    private org.zeroj.codec.SnarkjsPlonkProof proof;
    private org.zeroj.codec.SnarkjsPlonkVerificationKey vk;
    ...
    void setUp() {
        ...
        var inputs = org.zeroj.codec.SnarkjsJsonCodec.parsePublicInputs(
    ...
    private void addG1FromCoords(FiatShamirTranscript t, java.util.List<BigInteger> coords) {
        var pt = org.zeroj.verifier.groth16.bn254.G1Point.fromProjective(

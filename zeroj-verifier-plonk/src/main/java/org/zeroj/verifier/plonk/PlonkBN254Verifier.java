...
import org.zeroj.verifier.groth16.bn254.*;
...
public class PlonkBN254Verifier implements ZkVerifier {
    ...
    public VerificationResult verify(ZkProofEnvelope envelope, VerificationMaterial material) {
        ...
        try {
            ...
            var sp = org.zeroj.codec.SnarkjsPlonkCodec.parseProof(new String(envelope.proofBytes()));
            var sv = org.zeroj.codec.SnarkjsPlonkCodec.parseVerificationKey(new String(material.vkBytes()));

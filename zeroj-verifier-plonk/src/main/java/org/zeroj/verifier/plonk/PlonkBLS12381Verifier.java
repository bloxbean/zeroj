...
import org.zeroj.codec.CodecException;
...
public class PlonkBLS12381Verifier implements ZkVerifier {
    ...
    private static final BigInteger BASE_FIELD_MODULUS = org.zeroj.bls12381.field.Fp.P;
    ...
    public VerificationResult verify(ZkProofEnvelope envelope, VerificationMaterial material) {
        try {
            ...
            var sp = org.zeroj.codec.SnarkjsPlonkCodec.parseProof(proofJson);
            var sv = org.zeroj.codec.SnarkjsPlonkCodec.parseVerificationKey(vkJson);

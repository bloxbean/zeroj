...
class JacobianG1BLS381Test {
    ...
    void crossValidate_withVerifierG1Point() {
        ...
        var verG1 = new org.zeroj.bls12381.ec.G1Point(
                org.zeroj.bls12381.field.Fp.of(g.xBigInt()),
                org.zeroj.bls12381.field.Fp.of(g.yBigInt()));

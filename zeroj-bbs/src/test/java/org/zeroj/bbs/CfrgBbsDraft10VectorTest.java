...
import org.zeroj.bbs.spi.BbsProviders;
...
class CfrgBbsDraft10VectorTest {
    ...
    void messagesToScalars_matchDraft10Vector() {
        ...
        for (int i = 0; i < expected.size(); i++) {
            assertArrayEquals(hexString(expected.get(i)), org.zeroj.bbs.internal.BbsCodec.scalarToBytesAllowZero(actual.get(i)));
        }
    }
    ...
    void seededRandomScalars_matchDraft10MockVector() {
        ...
        for (int i = 0; i < expected.size(); i++) {
            assertArrayEquals(hexString(expected.get(i)), org.zeroj.bbs.internal.BbsCodec.scalarToBytesAllowZero(scalars.get(i)));
        }
    }

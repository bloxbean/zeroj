...
All approaches use the same `Groth16BLS12381Verifier` Plutus V3 script. Only the circuit and snapshot mechanism differ. You can start with Approach 1 and upgrade to Approach 3 or 4 later without changing the on-chain verifier.

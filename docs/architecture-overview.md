...
- `Groth16BLS12381Verifier` -- on-chain Groth16 verification using BLS12-381 builtins and arbitrary public-input counts
- `Groth16BLS12381` -- reusable `@OnchainLibrary` Groth16 verification helper for custom validators

...
import org.zeroj.crypto.groth16.Groth16Prover;
...
class Groth16SetupTest {
    ...
    private static G1Point toG1(org.zeroj.crypto.ec.JacobianG1BN254.AffineG1 p) {
        if (p.isInfinity()) return G1Point.INFINITY;
        return new G1Point(Fp.of(p.xBigInt()), Fp.of(p.yBigInt()));
    }

    private static G2Point toG2(org.zeroj.crypto.ec.JacobianG2BN254.AffineG2 p) {

...
import org.zeroj.verifier.groth16.bn254.BN254Pairing;
import org.zeroj.verifier.groth16.bn254.Fp;
import org.zeroj.verifier.groth16.bn254.Fp2;
import org.zeroj.verifier.groth16.bn254.G1Point;
import org.zeroj.verifier.groth16.bn254.G2Point;
...
class Groth16EndToEndTest {
    ...
    void fullPipeline_multiplier_proveAndVerify() throws IOException {
        ...
        var vk = org.zeroj.codec.SnarkjsJsonCodec.parseVerificationKey(vkJson);

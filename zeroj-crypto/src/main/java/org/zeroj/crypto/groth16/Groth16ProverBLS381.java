...
import org.zeroj.bls12381.field.FrArith381;
import org.zeroj.crypto.poly.FrFFTFlat;
import org.zeroj.crypto.msm.FlatScalars;
import org.zeroj.crypto.msm.PippengerFlatBLS381;
import org.zeroj.crypto.msm.G1MsmBackend;
import org.zeroj.crypto.msm.G2AffineReader;
import org.zeroj.crypto.poly.FieldFFTBLS381;
...
public final class Groth16ProverBLS381 {
     ...
     */
    public static BigInteger[] computeH(org.zeroj.api.R1CSFlat flat, BigInteger[] witness,
    ...
    /**
     * {@link #computeH(org.zeroj.api.R1CSFlat, BigInteger[], int, int)} with the
     ...
     */
    public static FlatScalars computeHFlat(org.zeroj.api.R1CSFlat flat, FlatScalars witness,
                                  int snarkjsBindingRows, int domainSize) {
    ...
    private static void evalRowInto(org.zeroj.api.R1CSFlat.Matrix m, long[] dictMont,
    ...
    private static JacobianG2BLS381 computePiB_G2(Groth16ProvingKeyBLS381 pk, G2AffineReader b2,
            org.zeroj.crypto.msm.G2MsmBackend g2Backend, FlatScalars witness, BigInteger s) {

...
public final class Groth16SetupCache {
    ...
    private static void validateGroth16SetupPoints(
            ...
            Object gammaG2,
            Object[] ic) throws IOException {
        SetupCacheIO.validateG1((org.zeroj.bls12381.ec.JacobianG1BLS381.AffineG1) alphaG1, false, "Groth16 alphaG1");
        SetupCacheIO.validateG1((org.zeroj.bls12381.ec.JacobianG1BLS381.AffineG1) betaG1, false, "Groth16 betaG1");
        SetupCacheIO.validateG2((org.zeroj.bls12381.ec.JacobianG2BLS381.AffineG2) betaG2, false, "Groth16 betaG2");
        SetupCacheIO.validateG1((org.zeroj.bls12381.ec.JacobianG1BLS381.AffineG1) deltaG1, false, "Groth16 deltaG1");
        SetupCacheIO.validateG2((org.zeroj.bls12381.ec.JacobianG2BLS381.AffineG2) deltaG2, false, "Groth16 deltaG2");
        SetupCacheIO.validateG2((org.zeroj.bls12381.ec.JacobianG2BLS381.AffineG2) gammaG2, false, "Groth16 gammaG2");
        SetupCacheIO.validateG1Array((org.zeroj.bls12381.ec.JacobianG1BLS381.AffineG1[]) pointsA, true, "Groth16 pointsA");
        SetupCacheIO.validateG1Array((org.zeroj.bls12381.ec.JacobianG1BLS381.AffineG1[]) pointsB1, true, "Groth16 pointsB1");
        SetupCacheIO.validateG2Array((org.zeroj.bls12381.ec.JacobianG2BLS381.AffineG2[]) pointsB2, true, "Groth16 pointsB2");
        SetupCacheIO.validateG1Array((org.zeroj.bls12381.ec.JacobianG1BLS381.AffineG1[]) pointsH, true, "Groth16 pointsH");
        SetupCacheIO.validateG1Array((org.zeroj.bls12381.ec.JacobianG1BLS381.AffineG1[]) pointsL, true, "Groth16 pointsL");
        SetupCacheIO.validateG1Array((org.zeroj.bls12381.ec.JacobianG1BLS381.AffineG1[]) ic, true, "Groth16 IC");
    }
}

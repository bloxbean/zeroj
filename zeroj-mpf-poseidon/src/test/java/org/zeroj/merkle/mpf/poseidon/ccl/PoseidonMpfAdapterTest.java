...
import org.zeroj.circuit.lib.poseidon.PoseidonParamsBN254T3;
...
class PoseidonMpfAdapterTest {
    ...
    void publicScalarEncoderRejectsFieldAliases() {
        BigInteger prime = org.zeroj.circuit.FieldConfig.BLS12_381.prime();
        assertThrows(IllegalArgumentException.class,
    ...
    void trieRejectsMalformedAndNonCanonicalRootBytesAtTheBoundary() {
        ...
        byte[] fieldAlias = org.zeroj.circuit.FieldConfig.BLS12_381
                .prime().toByteArray();

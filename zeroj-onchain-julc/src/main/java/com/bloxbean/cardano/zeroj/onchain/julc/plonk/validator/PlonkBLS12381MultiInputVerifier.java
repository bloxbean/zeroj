...
/**
 * Cardano-profile BLS12-381 PlonK verifier for bounded datum-supplied
 * multi-public-input circuits.
 */
@SpendingValidator
public class PlonkBLS12381MultiInputVerifier {
    ...
    static boolean validate(PlutusData datum, PlonkProof p, PlutusData ctx) {
        return PlonkBLS12381Lib.verifyMultiInputDatum(
                datum, p.publicInputInverses(),

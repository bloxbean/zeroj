 ...
 */
class Groth16BLS12381GenericVerifierTest extends ContractTest {
    ...
    private void assertGenericVerification(SnarkjsToCardano.VkCompressed vk,
        ...
        if (expectSuccess) {
            ...
            System.out.println("[Groth16BLS12381GenericVerifier] Budget consumed: " + result.budgetConsumed());
        } else {
    ...
    private static String loadResource(String path) throws IOException {
        try (var is = Groth16BLS12381GenericVerifierTest.class.getResourceAsStream(path)) {

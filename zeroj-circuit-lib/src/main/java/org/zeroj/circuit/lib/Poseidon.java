 ...
 *   <li>{@link org.zeroj.circuit.lib.poseidon.PoseidonParamsBLS12_381T3#INSTANCE}
 ...
 * {@code CurveId.BN254}), {@link org.zeroj.circuit.CircuitBuilder}
...
public final class Poseidon {
    ...
    public static Variable spongeHash(CircuitAPI api, PoseidonParams params,
        ...
        org.zeroj.circuit.lib.poseidon.PoseidonHash.requireExactRate(
                t, inputs.length);

...
class JubjubCleanupP5Test {
    ...
    void fixedBaseScalarMul_stillCorrect() {
        ...
        var circuit = org.zeroj.circuit.CircuitBuilder.create("fixed-base-value")
        ...
        assertDoesNotThrow(() -> circuit.calculateWitness(java.util.Map.of(
                ...
                "k", java.util.List.of(k)), org.zeroj.api.CurveId.BLS12_381));
    }
    ...
    void taggedT6Challenge_costsThePinnedConstraintCount() {
        var circuit = org.zeroj.circuit.CircuitBuilder.create("t6-challenge")
                .publicVar("out")
                .secretVar("a").secretVar("b").secretVar("c").secretVar("d").secretVar("e")
                .define(api -> {
                    var k = org.zeroj.circuit.lib.Poseidon.spongeHash(

package org.zeroj.circuit.lib.ed25519;
...
class Cip1852DerivationTest {
    ...
    void fullPath_withHints_stillMatchesCardanoClient() {
        boolean pm = org.zeroj.circuit.lib.field.Fe25519.USE_HINT_MUL;
        boolean pi = org.zeroj.circuit.lib.field.Fe25519.USE_HINT_INVERSE;
        try {
            org.zeroj.circuit.lib.field.Fe25519.USE_HINT_MUL = true;
            org.zeroj.circuit.lib.field.Fe25519.USE_HINT_INVERSE = true;
            ...
            org.zeroj.circuit.lib.field.Fe25519.USE_HINT_MUL = pm;
            org.zeroj.circuit.lib.field.Fe25519.USE_HINT_INVERSE = pi;
        }
    }
    ...
    private static int[] fullPathConstraintCounts(
        ...
        boolean pi = org.zeroj.circuit.lib.field.Fe25519.USE_HINT_INVERSE;
        try {
            org.zeroj.circuit.lib.field.Fe25519.USE_HINT_MUL = hintMul;
            org.zeroj.circuit.lib.field.Fe25519.USE_HINT_INVERSE = hintInv;
    ...
    private static Variable[] vars(org.zeroj.circuit.CircuitAPI api, String name) {

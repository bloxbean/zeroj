...
import org.zeroj.circuit.annotation.ZkCircuitMetadata;
...
import org.zeroj.examples.dsl.common.MiMCHash;
...
class AnnotatedCircuitExamplesTest {
    ...
    void ageVerificationHelperBuildsProverArtifactsAndProofEnvelope() {
        ...
        var response = new AnnotatedAgeVerificationProofHelper.ProverOutput(
                "{\"proof\":\"demo\"}",
                inputs.publicValues(),
                "groth16",
                CurveId.BN254.value());
        ...
        var mismatched = new AnnotatedAgeVerificationProofHelper.ProverOutput(
                "{}", List.of(BigInteger.ONE), "groth16", CurveId.BN254.value());
        assertThrows(IllegalArgumentException.class,
                () -> helper.toEnvelope(mismatched, inputs, new VerificationKeyRef.ById("vk-age-v1")));

        var wrongCurve = new AnnotatedAgeVerificationProofHelper.ProverOutput(
                "{}", inputs.publicValues(), "groth16", CurveId.BLS12_381.value());
        assertThrows(IllegalArgumentException.class,
